...
class Reporte_Factura_Cliente_Especial extends TCPDF {
    ...
    public function initialize($oReporte)
    {
        ...
        $this->oPeriodo = $this->_getPeriodo();
    }
    ...
    private function _getPeriodo()
    {        
        $this->CI->load->model("nomina/Periodo_model");
        $oPeriodo = $this->CI->Periodo_model->find(array(
            "idPeriodo" => $this->oReporte->idPeriodo
        ));
