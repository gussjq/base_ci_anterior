...
class Reporte_Acumulados_Anuales_Detalle  {
    ...
    public function generarReporte()
    {
        ...
        $oPHPExcel->getActiveSheet()->setCellValue("B" . $iRowCabecera, lang("reportes_reporte_acumulados_empleado"));
        ...
        foreach($aData AS $oData)
        {
            ...
            {   
                $oPHPExcel->getActiveSheet()->mergeCells("B" .$iRowDatos . ":O".$iRowDatos);   
                ...
                $oPHPExcel->getActiveSheet()->setCellValue("A" . $iRowDatos, lang("reportes_reporte_acumulado_tag_concepto"));
                $oPHPExcel->getActiveSheet()->setCellValue("B" . $iRowDatos, $oData->iNumeroConcepto . " : " .$oData->cNombreConcepto);
                $iRowDatos++;
            }
