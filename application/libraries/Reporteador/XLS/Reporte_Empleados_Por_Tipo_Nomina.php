...
class Reporte_Empleados_Por_Tipo_Nomina  {
    ...
    public function generarReporte()
    {
        ...
        $oPHPExcel->getActiveSheet()->setCellValue("C" . $iRowCabecera, lang("reportes_reporte_empleado_imss"));
        $oPHPExcel->getActiveSheet()->setCellValue("D" . $iRowCabecera, lang("reportes_reporte_empleado_puesto"));
        $oPHPExcel->getActiveSheet()->setCellValue("E" . $iRowCabecera, lang("reportes_reporte_empleado_salario"));
        $oPHPExcel->getActiveSheet()->setCellValue("F" . $iRowCabecera, lang("reportes_reporte_empleado_ingreso"));
        $oPHPExcel->getActiveSheet()->setCellValue("G" . $iRowCabecera, lang("reportes_reporte_empleado_razonsocial"));
        ...
        foreach($aData AS $oData)
        {
            ...
            $oPHPExcel->getActiveSheet()->setCellValue("C" . $iRowDatos, $oData->cIMSS);
            $oPHPExcel->getActiveSheet()->setCellValue("D" . $iRowDatos, $oData->cNombrePuesto);
            $oPHPExcel->getActiveSheet()->setCellValue("E" . $iRowDatos, $oData->fSalario);
            $oPHPExcel->getActiveSheet()->setCellValue("F" . $iRowDatos, $oData->dtFechaIngreso);
            $oPHPExcel->getActiveSheet()->setCellValue("G" . $iRowDatos, $oData->cRazonSocial);
