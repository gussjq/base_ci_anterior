<!-- 
Vista de listado del catalogo modulos
                ...
                <div class="span12">
                    <div class="btn-toolbar" id="toolbar">
                        ...
                        <div class="btn-wrapper" id="toolbar-new">
                            ...
                            <button onclick="modulos.btnAgregar();" class="btn btn-small btn-success">
                        ...
                        <div class="btn-wrapper" id="toolbar-publish">
                            <button onclick="modulos.btnListado();" class="btn btn-small">
                        ...
                        <?php if ($this->seguridad->verificarAcceso("modulos", "exportar")): ?>
                            <div class="btn-wrapper" id="toolbar-help">
                                <a href="<?php echo base_url("modulos/exportar/word"); ?>" rel="help" class="btn btn-small" target="_blank">
                            ...
                            <div class="btn-wrapper" id="toolbar-help">
                                <a href="<?php echo base_url("modulos/exportar/xls"); ?>" rel="help" class="btn btn-small" target="_blank">
                            ...
                            <div class="btn-wrapper" id="toolbar-help">
                                <a href="<?php echo base_url("modulos/exportar/csv"); ?>" rel="help" class="btn btn-small" target="_blank">
                            ...
                            <div class="btn-wrapper" id="toolbar-help">
                                <a href="<?php echo base_url("modulos/exportar/pdf"); ?>" rel="help" class="btn btn-small" target="_blank">
                            ...
                            <td>
                                <div class="ui-corner-all envoltura-tabla">
                                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="listado">
                                        <thead>
                                            <tr>
                                                <th><?php echo lang('modulos_nombre'); ?></th>
                                                <th><?php echo lang('modulos_alias'); ?></th>
                                                <th><?php echo lang('modulos_descripcion_modulo'); ?></th>
...
<script type="text/javascript" >
    var acciones = {
        "editar": "<?php echo incluye_icono("editar", lang("general_accion_editar"), "float:left;", base_url() . "modulos/forma/@@@@", "", true, "actualizar") ?>",
        "habilitar": "<?php echo incluye_icono("habilitar", lang("general_accion_habilitar"), "float:left;", "#", "onclick=\'modulos.btnCmd(@@@@, @@@@@)\'", true, "habilitar"); ?>",
        "deshabilitar": "<?php echo incluye_icono("deshabilitar", lang("general_accion_deshabilitar"), "float:left;", "#", "onclick=\'modulos.btnCmd(@@@@, @@@@@)\'", true, "deshabilitar"); ?>",
        "acciones": "<?php echo incluye_icono("acciones", lang("acciones_titulo"), "float:left;", base_url() . "acciones/listado/@@@@", "", true, "listado", "acciones"); ?>",
    };
...
//        $.fn.dataTable.TableTools.DEFAULTS.sSwfPath = Generic.BASE_URL + Generic.DIRECTORIO_JAVASCRIPT + 'plugins/Datatables/extras/TableTools/media/swf/copy_csv_xls_pdf.swf';
        oTable = $('#listado').dataTable({
            ...
            "aoColumns": [
                ...
                {"sName": "cAlias"},
                {"sName": "cDescripcion"},
                {"sName": "idModulo", "bSortable": false, "sWidth": "10%"},
            ...
            "fnServerData": function(sSource, aoData, fnCallback) {
                aoData[aoData.length] = {name: "cNombre", value: modulos.cNombreBus};
                aoData[aoData.length] = {name: "cAlias", value: modulos.cAliasBus};
                dataTableUI.tablePipeLine(sSource, aoData, fnCallback);
            },
            "fnRowCallback": function(nRow, aData, iDisplayIndex) {
                var cActions = '<div class="fg-buttonset">';
                
                cActions += acciones["acciones"].replace("@@@@", aData[3]) + "\n";
