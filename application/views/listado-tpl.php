...
Vista o capa de presentacion de la pantalla del catálogo de empresas en donde se mostraran  las empresas
registradas en el sistema en un formato de listado, en donde  se cuenta con las opciones de exportar a Excel, CSV, Word, PDF, agregar, actualizar y borrar
segun el nivel de acceso que tenga el usuario, ademas contara con un menu de acceso rapido a el proceso de configuracion
                ...
                <div class="row-fluid">
                    <div id="busqueda-avanzada" style="display: none;" >
                        <div class="contenedor_gris">
                            <?php echo form_open("empresas/busqueda-avanzada", "id=\"forma-modulo_singular-minuscula-busqueda-avanzada\" "); ?>
                            <table class="tbl-busqueda-avanzada">
                                <tbody>
                                    <tr>
                                        <td><label class="control-label" for="cNombre"><?php echo lang("empresas_nombre"); ?> :</label></td>
                                        <td><?php echo form_input("cNombre", "", "id=\"cNombreBus\"class=\"input-large\" maxlength=\"45\""); ?></td>
                                    </tr>
...
<script type="text/javascript" >
    var acciones = {
        ...
        "eliminar": "<?php echo incluye_icono("eliminar", lang("acciones_titulo"), "float:left;", "#", "onclick=\'empresas.btnEliminar(@@@@,????)\'", true, "eliminar"); ?>",
    };
    ...
    $(document).ready(function () {
        oTable = $('#listado').dataTable({
            ...
            "aoColumns": [
                {"sName": "cNombre"},
                {"sName": "idmodulo_singular", "sWidth": "10%"},
            ],
            ...
            "fnServerData": function (sSource, aoData, fnCallback) {
                ...
                aoData[aoData.length] = {name: "cAlias", value: empresas.cAlias};
