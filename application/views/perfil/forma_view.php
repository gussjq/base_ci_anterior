...
Vista de forma del catalogo Perfil
                ...
                <div class="span12">
                    <div class="btn-toolbar" id="toolbar">
                        ...
                        <div class="btn-wrapper" id="toolbar-new">
                            <button onclick="perfil.btnGuardarForma();" class="btn btn-small btn-success">
                        ...
                        <div class="btn-wrapper" id="toolbar-cancel">
                            <button onclick="perfil.btnDashboard();" class="btn btn-small">
                        ...
                        <div class="btn-wrapper" id="toolbar-help">
                            ...
                            <button onclick="perfil.btnMostrarEmpresas();" rel="help" class="btn btn-small">
            ...
            <div class="span10">
                ...
                <div class="row-fluid" >
                    <div class="span11">
                        <div class="center encabezado-catalogo">
                            <div class="texto-encabezado"><?php echo lang('perfil_titulo'); ?> </div>
                        </div>
                    </div>
                </div>
                
                <!-- INICIO AREA DEL FORMULARIO  -->
                <?php echo form_open("perfil/actualizar", "id=\"forma-perfil\" class=\"form-horizontal\""); ?>
                <input type="hidden" id="id" name="idUsuario" value="<?php echo $oUsuario->idUsuario; ?>" />
                <input type="hidden" id="bNuevo" name="bNuevo" value="<?php echo $oUsuario->bNuevo; ?>" />
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_input("cNombre", $oUsuario->cNombre, "id=\"cNombre\"class=\"input-large validate[required, maxSize[45]\" maxlength=\"45\" disabled=\"disabled\" "); ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_input("cApellidoPaterno", $oUsuario->cApellidoPaterno, "id=\"cApellidoPaterno\"class=\"input-large validate[required, maxSize[45]]\" maxlength=\"45\" disabled=\"disabled\""); ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_input("cApellidoMaterno", $oUsuario->cApellidoMaterno, "id=\"cApellidoMaterno\"class=\"input-large validate[required, maxSize[45]]\" maxlength=\"45\" disabled=\"disabled\""); ?>
                                    <span class="help-block"><?php echo lang("usuario_apellido_materno_help"); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="span6">
                            <div id="contenedor-archivo" style="margin:0 0 5px 100px;">
                ...
                <fieldset>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group">
                                <label class="control-label" for="cCorreo"><?php echo lang("usuario_rol"); ?> :</label>
                                <div class="controls">
                                    <?php echo form_dropdown("idRol", $aCombosForma['aRoles'], $oUsuario->idRol, "id=\"idRol\"class=\"input-large validate[required]\" disabled=\"disabled\""); ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_input("cCorreo", $oUsuario->cCorreo, "id=\"cCorreo\"class=\"input-large validate[required, maxSize[45], custom[email]]\" maxlength=\"45\" disabled=\"disabled\""); ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_password("cContrasena", "", "id=\"cContrasena\"class=\"input-large validate[required, maxSize[" . (ConfigHelper::get("iMaxContrasena")) . "], minSize[" . (ConfigHelper::get("iMinContrasena")) . "]]\" maxlength=\"" . (ConfigHelper::get('iMaxContrasena')) . "\""); ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_password("cConfirmarContrasena", "", "id=\"cConfirmarContrasena\"class=\"input-large validate[required]\" maxlength=\"" . (ConfigHelper::get('iMaxContrasena')) . "\""); ?>
...
<?php script_tag("modulos/perfil"); ?>

<script type="text/javascript">
    
    $(document).ready(function() {
        var bRequerido = perfil.validarContrasenaUsuarioNuevo();
        perfil.initForma({
            'paramsForma': {
               rules:{
                   idIdioma:{
